                                    ...
                                    <tbody class="divide-y divide-gray-800">
                                        ...
                                        <tr>
                                            ...
                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-300">
                                                @if($task['completed'])
                                                <span
                                                    class="bg-green-500 text-white rounded-full text-xs font-medium py-1 px-4">
                                                    Completed
                                                </span>
                                                @else
                                                <span
                                                    class="bg-gray-500 text-white rounded-full text-xs font-medium py-1 px-3">
                                                    incompleted
                                                </span>
                                                @endif
                                            </td>
                                            <td
                                                class="relative flex gap-2 items-center justify-end truncate whitespace-nowrap py-4 pl-3 pr-4 text-sm font-medium sm:pr-0">
                                                @if(!$task['completed'])
